          ...
          <div className="blog__cards-blog">
            ...
            <div className="blog__card-blog card-blog blog__card-events card-events">
              <div className="card-blog__info card-events__info">
                ...
                <h5 className="card-blog__subtitle">Ярмарка — мероприятие, организованное с целью покупки и продажи товаров и услуг.<br />
            ...
            <div className="blog__card-blog card-blog blog__card-events card-events">
              <div className="card-blog__info card-events__info">
                ...
                <h5 className="card-blog__subtitle">Мировая культура знала фестивали ещё с античных времен. С одной стороны - это своего рода смотр достижений каких-либо видов искусств. А с другой - фестивали носят развлекательный характер. Пожалуй, на сегодняший день, их можно отнести к одному и к другому направлению. Таким образом фестиваль — это яркий праздник на котором можно встретить ценителей различных видов искусств и ремёсел.</h5>
              </div>
              <button className="card-blog__button _button">
