    ...
    <div className="events">
      <div className="events__container _container">
        <div className="events__body">
          ...
          <h5 className="events__subtitle">Мировая культура знала фестивали ещё с античных времен. С одной стороны - это своего рода смотр достижений каких-либо видов искусств. А с другой - фестивали носят развлекательный характер. Пожалуй, на сегодняший день, их можно отнести к одному и к другому направлению. Таким образом фестиваль — это яркий праздник на котором можно встретить ценителей различных видов искусств и ремёсел.</h5>
