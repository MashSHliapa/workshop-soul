        ...
        <div className="contacts__body">
          ...
          <div className="contacts__row">
            <div className="contacts__column">
              ...
              <h5 className="contacts__text">На данном сайте Вы можете ознакомиться с моими <span>изделиями</span>. Выбрав понравившееся, отправьте его название или фото мне удобным для Вас способом: <br />
            ...
            <div className="contacts__column">
              ...
              <h5 className="contacts__text">Доставка осуществляется
                ...
                Стоимость доставки просчитывается службой СДЭК, исходя из габаритов посылки </h5>
            </div>
