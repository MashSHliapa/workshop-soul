  ...
  initialState: {
    data: [
      ...
      },
      {
        ...
        name: '“Ты - лучшая”',
        size: '10x25',
        material: 'Камень и дерево хвойных пород камень и дерево хвойных пород и еще какой-то текст для описания данного изделия',
      },
      {
        id: '3',
        image: bijouterie3,
        ...
        name: '“Василек”',
        size: '40x45',
        material: 'Камень и дерево хвойных пород камень и дерево хвойных пород и еще какой-то текст для описания данного изделия, полностью подчеркивающую особенность и нужность именно Вам!!',
      },
      {
        id: '4',
        image: bijouterie4,
