  ...
  initialState: {
    data: [
      ...
      },
      {
        ...
        text1: 'Уютная встреча с любимыми мастерами Уютная встреча с любимыми мастерами',
        text2: 'Обложки на документы из натуральной кожи с забавными изображениями свечи Уютная встреча с любимыми мастерами',
      ...
      },
      {
        ...
        text2: 'Обложки на документы из натуральной кожи с забавными изображениямисвечи из соевого воска и арома-диффузоры с оригинальными ароматамиигрушки из кожи и меха Обложки на ',
